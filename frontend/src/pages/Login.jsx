    ...
    <div className="min-h-screen flex items-center justify-center bg-[#f8fafc] p-6 relative overflow-hidden font-jakarta">
      ...
      <div className="w-full max-w-[500px] relative z-10">
        <div className="text-center mb-10">
          ...
          <h1 className="text-5xl font-black text-slate-800 tracking-tightest mb-2">
          ...
          <form onSubmit={handleLogin} className="space-y-6 lg:space-y-8">
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input type="text" id="username" name="username" className="block w-full pl-14 pr-6 py-5 bg-white/50 border border-white focus:bg-white focus:border-green-500 rounded-[1.5rem] outline-none transition-all font-bold text-slate-700 shadow-sm" placeholder="Username" value={username} onChange={(e) => setUsername(e.target.value)} required />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input type="password" id="password" name="password" className="block w-full pl-14 pr-6 py-5 bg-white/50 border border-white focus:bg-white focus:border-green-500 rounded-[1.5rem] outline-none transition-all font-bold text-slate-700 shadow-sm" placeholder="Password" value={password} onChange={(e) => setPassword(e.target.value)} required />
              </div>
            </div>
            ...
            <button type="submit" disabled={loading} className="w-full bg-slate-900 hover:bg-slate-800 text-white font-black py-6 rounded-[1.5rem] shadow-xl hover:shadow-2xl hover:scale-[1.02] active:scale-95 transition-all disabled:opacity-70 flex items-center justify-center gap-3 text-lg lg:text-xl">
              {loading ? <div className="w-6 h-6 border-3 border-white/30 border-t-white rounded-full animate-spin"></div> : <>Masuk ke Dashboard</>}
            </button>
          </form>
