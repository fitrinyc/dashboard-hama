    ...
    <div className="max-w-4xl mx-auto space-y-4 lg:space-y-10 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="bg-white rounded-2xl lg:rounded-[3.5rem] border border-slate-100 shadow-xl overflow-hidden">
        <div className="h-24 lg:h-40 bg-gradient-to-r from-green-600 to-emerald-500 relative">
          <div className="absolute -bottom-10 lg:-bottom-16 left-6 lg:left-14">
            <div className="w-20 h-20 lg:w-32 lg:h-32 bg-white rounded-2xl lg:rounded-[2.5rem] p-1 shadow-2xl">
              <div className="w-full h-full bg-slate-100 rounded-xl lg:rounded-[2rem] flex items-center justify-center text-3xl lg:text-6xl font-black text-green-600">
        ...
        <div className="pt-14 lg:pt-24 pb-8 lg:pb-14 px-6 lg:px-14">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6">
            <div className="text-center md:text-left">
              <h2 className="text-2xl lg:text-5xl font-black text-slate-800 leading-none mb-2">{userData.username}</h2>
            ...
            <div className="flex justify-center md:justify-end gap-3 lg:gap-6">
              <div className="px-5 lg:px-8 py-2 lg:py-4 bg-green-50 border-2 border-green-100 rounded-xl lg:rounded-3xl text-center">
                <p className="text-[8px] lg:text-xs font-black text-green-600 uppercase tracking-widest mb-1 lg:mb-2">Status Akun</p>
                <p className="text-[10px] lg:text-xl font-black text-green-700 uppercase">Sangat Aktif</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 lg:gap-12">
        <div className="md:col-span-2 space-y-4 lg:space-y-10">
          <div className="bg-white p-6 lg:p-14 rounded-2xl lg:rounded-[3rem] border border-slate-100 shadow-xl">
            <h3 className="text-lg lg:text-3xl font-black text-slate-800 mb-6 lg:mb-12 flex items-center gap-3 lg:gap-5 leading-none">
              <User className="w-6 h-6 lg:w-10 lg:h-10 text-green-600" /> Profil Bapak/Ibu
            </h3>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 lg:gap-14">
        ...
        <div className="space-y-4 lg:space-y-10">
          <div className="bg-white p-6 lg:p-14 rounded-2xl lg:rounded-[3rem] border border-slate-100 shadow-xl text-center flex flex-col items-center">
            <div className="w-16 h-16 lg:w-24 lg:h-24 bg-green-50 rounded-2xl lg:rounded-[2rem] flex items-center justify-center mb-4 lg:mb-8 text-green-600 border-2 border-green-100">
              <Leaf className="w-8 h-8 lg:w-12 lg:h-12" />
            </div>
            <h4 className="font-black text-slate-800 tracking-tight text-lg lg:text-3xl leading-none">Lahan Sawah</h4>
            <div className="mt-6 lg:mt-10 space-y-4 w-full text-left">
              <div className="p-4 lg:p-8 bg-slate-50 rounded-xl lg:rounded-[2rem] border-2 border-slate-100">
...
function ProfileItem({ icon, label, value }) {
  return (
    <div className="space-y-1 lg:space-y-3 p-4 lg:p-0 bg-slate-50 lg:bg-transparent rounded-xl lg:rounded-none">
      ...
      <p className="text-sm lg:text-3xl font-black text-slate-800 leading-tight">{value}</p>
    </div>
  );
}
